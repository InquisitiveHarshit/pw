            ...
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center group">
                <Image
                  ...
                  width={250}
                  height={100}
                  className="h-24 w-auto transition-transform duration-300 group-hover:scale-[1.02]"
                  priority
                />
              </Link>
            </div>
              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`relative px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 group ${isActive
                      ? "text-[#FFA100]"
                  ...
                  >
                    ...
                    <span
                      className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 bg-[#FFA100] rounded-full transition-all duration-300 ${isActive ? "w-4/5" : "w-0 group-hover:w-4/5"
                        }`}
                    />
                  </Link>
                );
                  ...
                  <div className="flex items-center gap-3 relative group">
                    ...
                    <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-[#C7C0AE]/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden">
                      ...
                      <div className="px-5 py-3 border-b border-[#C7C0AE]/20 flex items-center gap-2">
                        <span className={`text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider ${user?.role === "admin"
            ...
            {NAV_LINKS.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center px-3 py-2.5 rounded-md text-base font-medium transition-colors ${isActive
